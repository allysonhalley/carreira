...
\begin{experiences}
    \experience
        {Setembro 2026} {H\&Fti (\url{https://www.hefti.com.br})}{Arquiteto de Software}{}
        ...
        Principais frentes e entregas:
            \begin{itemize}
               ...
               \item Aceleração com IA: Integração de fluxos de desenvolvimento com IA (Antigravity e vibecoding contextualizado, análise preditiva de bugs e documentação automática).
              \end{itemize}
            }
            {Arquitetura Distribuída, Antigravity, IA, CI/CD, Docker, Rancher, Cloudflare, Relacional/NoSQL, Vibecoding}
    \emptySeparator
    \experience
        ...
        {Setembro 2026} { Atuação na liderança técnica e de equipe do projeto BPORT, com foco em maturidade de engenharia, eficiência de processos e pioneirismo na adoção de Inteligência Artificial aplicada ao ciclo de desenvolvimento.
            \begin{itemize}
               ...
               \item Engenharia de Contexto \& Metodologia: Estruturação de regras e contextos avançados para desenvolvimento assistido por IA e ferramentas agentless (Antigravity, Cursor, Vibecoding).
            ...
            {Liderança Técnica, Inteligência Artificial, Antigravity, Cursor, SDLC, Git Flow, Vibecoding}
    \emptySeparator
    \experience
    ...
    \emptySeparator
    \experience
        {Fevereiro 2024} {H\&Fti (\url{https://www.hefti.com.br})}{Desenvolvedor FullStack}{}
